...
<component name="PhotoCycle" extends="Group">
  ...
  <children>
    ...
    <Animation id="kenBurnsA" duration="8" repeat="false" easeFunction="linear" control="start">
    ...
    <Animation id="kenBurnsB" duration="8" repeat="false" easeFunction="linear">
...
- **Photos**: `scripts/gen-screensaver-photos.mjs` emits 8 deterministic JPEGs via sharp inline-SVG (gradient + "Sample Photo N" text overlay). Pinned sharp params: `kernel: 'lanczos3'`, `compressionLevel: 9`, `palette: false`, JPEG quality `82`. Verified byte-equal across runs on darwin/arm64.
